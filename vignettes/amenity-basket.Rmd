...
tutorial cheap we take the central blocks within a radius; `$place_blocks(city$geoid)`
...
Parks and restaurants tend to be everywhere; supermarkets and frequent transit are
usually the hardest to reach. Map one amenity — every block shown, the covered ones
highlighted.
