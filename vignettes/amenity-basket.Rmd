...
of it — a `direction = "from"` walk isochrone (1 token each). We greedily pick the
...
Just inside a 5,000-token month. Shrink `radius_m` or the candidate count to trade
coverage for budget.
