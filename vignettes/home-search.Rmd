...
Pull the per-block walk times for the blocks around the city centre. The result is an
sf table with one row per (block, category); block boundaries come from `tigris`,
