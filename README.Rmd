...
Feature methods return sf by default. Block routes join census-block boundaries for
you (this needs the `tigris` package, which downloads the boundaries once and caches
them). To work with the raw data instead, set the client's `spatial` flag to FALSE:
