...
15-minute walk of it — a `direction = "from"` walk isochrone (10 tokens
...
- Up to 25 candidate isochrones (1 contour each, 10 tokens): ~250
  tokens.

Around 4,300 tokens – inside a 5,000-token month. Shrink `radius_m` or
the candidate count to trade coverage for budget.
