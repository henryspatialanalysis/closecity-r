...
draws any result on an interactive CARTO Positron basemap in one line —
bright hoverable points, or blocks shaded by travel time, zoomed to the
data. (The image below is a snapshot; in a session or the
[tutorials](https://henryspatialanalysis.github.io/closecity-r/articles/)
...
![Supermarkets across Providence, drawn as orange points over a CARTO
Positron basemap.](reference/figures/README-first-call.png)
